using AetherStrap.UI.ViewModels;
...
namespace AetherStrap.UI.Elements.Controls
{
    /// <summary>
    ...
    class MarkdownTextBlock : TextBlock
    {
        ...
        private static void OnTextMarkdownChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            ...
            // https://github.com/AetherStraplabs/AetherStrap/blob/289b9dec77cf35b2cc6504019bc9c7701626be1f/AetherStrap/UI/Elements/Controls/MarkdownTextBlock.cs#L111
